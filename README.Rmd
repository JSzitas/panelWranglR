...
[![Travis build status](https://travis-ci.org/JSzitas/tidyPanelR.svg?branch=master)](https://travis-ci.org/JSzitas/tidyPanelR)
<!-- badges: end -->
...
```
The latest version is also available from [github](https://github.com/JSzitas/panelWranglR) using the *devtools* package
...
Or maybe we want to turn the cross section variable into a dummy variable:
